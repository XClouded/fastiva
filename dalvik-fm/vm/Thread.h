...
#ifdef FASTIVA
#ifdef _WIN32
	#define FASTIVA_SCAN_INTO_JNI_STACK		0
#else
	#define FASTIVA_SCAN_INTO_JNI_STACK		0
#endif
#endif
...
#else
    THREAD_NATIVE       = THREAD_RUNNING,        /* For JNI Stack scan */
#endif
...
#ifdef FASTIVA
	int m_inProcessInitStatic;
	int m_exceptionCount;
	fastiva_Rewinder* m_pTopRewinder;
	fastiva_ExceptionContext* m_pTopHandler;
	void* m_pNativeStackBottom;
	void* m_pNativeStackPointer;
	fastiva_Class_p m_pCallerClass;
	fastiva_Class_p m_pCallerAppClass;
#endif
