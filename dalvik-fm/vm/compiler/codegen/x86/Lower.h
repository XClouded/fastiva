...
#define offClassObject_descriptor FASTIVA_ALTERNATE(24, 28)
#define offArrayObject_length FASTIVA_ALTERNATE(8, 16)
...
#define offClassObject_status FASTIVA_ALTERNATE(44, 48)
#define offClassObject_accessFlags FASTIVA_ALTERNATE(32, 36)
#ifdef MTERP_NO_UNALIGN_64
#define offArrayObject_contents FASTIVA_ALTERNATE(16, 24) && ???
#else
#define offArrayObject_contents FASTIVA_ALTERNATE(12, 24)
#endif

#define offField_clazz 0
#define offObject_clazz FASTIVA_ALTERNATE(0, 4)
#define offClassObject_vtable FASTIVA_ALTERNATE(116, 116)
#define offClassObject_pDvmDex FASTIVA_ALTERNATE(40, 44)
#define offClassObject_super FASTIVA_ALTERNATE(72, 76)
#define offClassObject_vtableCount FASTIVA_ALTERNATE(112, 112)
...
#define offThread_inJitCodeCache FASTIVA_ALT_W32(124, 128)
#define offThread_jniLocal_nextEntry FASTIVA_ALT_W32(168, 172) // ?? May be incorrect ??
#define offMethod_insns 32
#ifdef FASTIVA
#define offMethod_jniArgInfo 36
#endif
