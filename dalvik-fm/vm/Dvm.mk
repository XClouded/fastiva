...
LOCAL_SRC_FILES += fastiva/src/dalvik_Class.cpp \
                   fastiva/src/dalvik_Exception.cpp \
                   fastiva/src/dalvik_Kernel.cpp \
                   fastiva/src/dalvik_Runtime.cpp \
                   fastiva/src/dalvik_Sys.cpp \
                   fastiva/src/dalvik_Fni.cpp \
                   fastiva/src/module.cpp \
                   fastiva/src/fastiva_cod.cpp \
                   fastiva/src/StringPool.cpp \

ifeq ($(ARCH),x86)
    LOCAL_LDFLAGS += $(JPP_OUT_DIR)/libs/x86/libfastiva.so
else
LOCAL_LDFLAGS += $(JPP_OUT_DIR)/libs/armeabi-v7a/libfastiva.so
endif

#PRIVATE_LDLIBS += $(JPP_OUT_DIR)/libs/armeabi-v7a/libfastiva.so
