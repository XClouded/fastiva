...
const DalvikNativeMethod dvm_java_lang_Double[] = {
    { "doubleToLongBits",    "(D)J", Double_doubleToLongBits, NULL },
    { "doubleToRawLongBits", "(D)J", Double_doubleToRawLongBits, NULL },
    { "longBitsToDouble",    "(J)D", Double_longBitsToDouble, NULL },
    { NULL, NULL, NULL, NULL },
};
