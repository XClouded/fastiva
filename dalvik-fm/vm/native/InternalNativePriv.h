...
#ifdef FASTIVA
#define DALVIK_RETURN_VOID()          do { (void)(pResult); return; } while(0)
#define DALVIK_RETURN_BOOLEAN(_val)   do { pResult->i = (_val); return; } while(0)         
#define DALVIK_RETURN_INT(_val)       do { pResult->i = (_val); return; } while(0)         
#define DALVIK_RETURN_LONG(_val)      do { pResult->j = (_val); return; } while(0)         
#define DALVIK_RETURN_FLOAT(_val)     do { pResult->f = (_val); return; } while(0)         
#define DALVIK_RETURN_DOUBLE(_val)    do { pResult->d = (_val); return; } while(0)         
#define DALVIK_RETURN_PTR(_val)       do { pResult->l = (Object*)(_val); return; } while(0)
...
struct fastiva_PendingExceptionChecker { 
	~fastiva_PendingExceptionChecker() {
		fastiva_popDalvikException();
	}
};

#define THROW_V()				{ fastiva_PendingExceptionChecker fpec; return 0; }
#define THROW_VOID()			{ fastiva_PendingExceptionChecker fpec; return; }
#define MAY_THROW_VOID()		{ fastiva_PendingExceptionChecker fpec; return; }
#define RETURN_VOID()			{ fastiva_PendingExceptionChecker fpec; return; } 
#define RETURN_BOOLEAN(_val)	{ fastiva_PendingExceptionChecker fpec; return (_val); }
#define RETURN_INT(_val)		{ fastiva_PendingExceptionChecker fpec; return (_val); }
#define RETURN_LONG(_val)		{ fastiva_PendingExceptionChecker fpec; return (_val); }
#define RETURN_FLOAT(_val)		{ fastiva_PendingExceptionChecker fpec; return (_val); }
#define RETURN_DOUBLE(_val)		{ fastiva_PendingExceptionChecker fpec; return (_val); }
#define RETURN_PTR(_val)		{ fastiva_PendingExceptionChecker fpec; return (_val); }

#else
	#define THROW_V()			RETURN_VOID()
	#define THROW_VOID()		RETURN_VOID()
	#define MAY_THROW_VOID()	RETURN_VOID()
#endif
