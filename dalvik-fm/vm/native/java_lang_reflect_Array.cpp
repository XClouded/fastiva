...
#ifdef FASTIVA
	java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Array_createObjectArray(java_lang_Class_p clazz, jint);
	*(java_lang_Object_p*)pResult = fastiva_Dalvik_java_lang_reflect_Array_createObjectArray((java_lang_Class_p)elementClass, length);
}

java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Array_createObjectArray(java_lang_Class_p elementClass, jint length) {
#endif
...
#ifdef FASTIVA
	java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Array_createMultiArray(java_lang_Class_p clazz, Int_ap);
	*(java_lang_Object_p*)pResult = fastiva_Dalvik_java_lang_reflect_Array_createMultiArray((java_lang_Class_p)elementClass, (Int_ap)dimArray);
}

java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Array_createMultiArray(java_lang_Class_p elementClass, Int_ap arg1) {
    ArrayObject* dimArray = (ArrayObject*) arg1;
#endif
...
const DalvikNativeMethod dvm_java_lang_reflect_Array[] = {
    { "createObjectArray",  "(Ljava/lang/Class;I)Ljava/lang/Object;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Array_createObjectArray) },
    { "createMultiArray",   "(Ljava/lang/Class;[I)Ljava/lang/Object;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Array_createMultiArray) },
    { NULL, NULL, NULL, NULL },
};
