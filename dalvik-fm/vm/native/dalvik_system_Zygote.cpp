...
#include <sched.h>
#endif
#if !defined(_WIN32) // && FASTIVA_TARGET_ANDROID_VERSION >= 40400
...
#ifdef FASTIVA
	jint fastiva_Dalvik_dalvik_system_Zygote_fork();
	*(jint*)pResult = fastiva_Dalvik_dalvik_system_Zygote_fork();
}
...
#if FASTIVA_TARGET_ANDROID_VERSION<40400
# define setresgid(gid, gid2, gid3) setgid(gid)
# define setresuid(uid, uid2, uid3) setuid(uid)
#endif
    ...
    JValue* pResult)
{
    ...
    DALVIK_RETURN_INT(pid);
}


#ifdef FASTIVA
jint fastiva_Dalvik_dalvik_system_Zygote_forkAndSpecialize(jint a1, jint a2, Int_ap a3, jint a4, Int_aap a5, jint a6, java_lang_String_p a7, java_lang_String_p a8) {
        int args[] = {a1, a2, (int)a3, a4, (int)a5, a6, (int)a7, (int)a8};
	JValue res;
	pid_t pid = forkAndSpecializeCommon((const u4*)args, false);
	fastiva_popDalvikException();
        return pid;
}
#endif
...
#ifdef FASTIVA
jint fastiva_Dalvik_dalvik_system_Zygote_forkSystemServer(jint a1, jint a2, Int_ap a3, jint a4, Int_aap a5, jlonglong a6, jlonglong a8) {
        int args[] = {a1, a2, (int)a3, a4, (int)a5, (jint)a6, (jint)(a6>>32), (jint)a8, (jint)(a8>>32)};
	JValue res;
	Dalvik_dalvik_system_Zygote_forkSystemServer((u4*)args, &res);
	fastiva_popDalvikException();
	return res.i;
}
#endif
...
#ifdef FASTIVA
	void fastiva_Dalvik_dalvik_system_Zygote_execShell(java_lang_String_p);
	fastiva_Dalvik_dalvik_system_Zygote_execShell((java_lang_String_p)command);
}

void fastiva_Dalvik_dalvik_system_Zygote_execShell(java_lang_String_p command) {
#endif
...
const DalvikNativeMethod dvm_dalvik_system_Zygote[] = {
    { "nativeFork", "()I",
      FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_dalvik_system_Zygote_fork) },
    { "nativeForkAndSpecialize", "(II[II[[IILjava/lang/String;Ljava/lang/String;)I",
      FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_dalvik_system_Zygote_forkAndSpecialize) },
    { "nativeForkSystemServer", "(II[II[[IJJ)I",
      FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_dalvik_system_Zygote_forkSystemServer) },
#if FASTIVA_TARGET_ANDROID_VERSION < 40400
	{ "nativeExecShell", "(Ljava/lang/String;)V",
      FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_dalvik_system_Zygote_execShell) },
#endif
    { NULL, NULL, NULL, NULL },
};
