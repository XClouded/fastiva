...
#ifdef FASTIVA
	java_lang_Object_ap fastiva_Dalvik_java_lang_reflect_AccessibleObject_getClassSignatureAnnotation(java_lang_Class_p);
	*(java_lang_Object_ap*)pResult = fastiva_Dalvik_java_lang_reflect_AccessibleObject_getClassSignatureAnnotation((java_lang_Class_p)clazz);
}

java_lang_Object_ap fastiva_Dalvik_java_lang_reflect_AccessibleObject_getClassSignatureAnnotation(java_lang_Class_p clazz) {
#endif
...
const DalvikNativeMethod dvm_java_lang_reflect_AccessibleObject[] = {
    { "getClassSignatureAnnotation", "(Ljava/lang/Class;)[Ljava/lang/Object;",
      FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_AccessibleObject_getClassSignatureAnnotation) },
    { NULL, NULL, NULL, NULL },
};
