...
#ifdef FASTIVA
	void fastiva_Dalvik_org_apache_harmony_dalvik_NativeTestTarget_emptyInternalMethod();
	fastiva_Dalvik_org_apache_harmony_dalvik_NativeTestTarget_emptyInternalMethod();
}
...
const DalvikNativeMethod dvm_org_apache_harmony_dalvik_NativeTestTarget[] =
{
    { "emptyInternalStaticMethod", "()V",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_org_apache_harmony_dalvik_NativeTestTarget_emptyInternalMethod) },
    { NULL, NULL, NULL, NULL },
};
