...
#ifdef FASTIVA
	java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Constructor_constructNative(java_lang_reflect_Constructor_p self, java_lang_Object_ap, java_lang_Class_p clazz, java_lang_Class_ap, jint, jbool);
	*(java_lang_Object_p*)pResult = fastiva_Dalvik_java_lang_reflect_Constructor_constructNative((java_lang_reflect_Constructor_p)args[0], (java_lang_Object_ap)argList, (java_lang_Class_p)declaringClass, (java_lang_Class_ap)params, slot, noAccessCheck);
}

java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Constructor_constructNative(java_lang_reflect_Constructor_p self, java_lang_Object_ap argList, java_lang_Class_p declaringClass, java_lang_Class_ap params, jint slot, jbool noAccessCheck) {
#endif
    ...
    (void) dvmInvokeMethod(newObj, meth, (ArrayObject*)argList, (ArrayObject*)params, NULL, noAccessCheck);
...
const DalvikNativeMethod dvm_java_lang_reflect_Constructor[] = {
    { "constructNative",    "([Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;IZ)Ljava/lang/Object;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Constructor_constructNative) },
    { NULL, NULL, NULL, NULL },
};
