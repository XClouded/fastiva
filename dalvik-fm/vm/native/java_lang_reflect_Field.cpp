    ...
    int slot, bool isSetOperation, bool noAccessCheck)
{
    ...
    if (!noAccessCheck) {
        ...
        ClassObject* callerClass =
            d2f_getCallerClass(dvmThreadSelf());
#else
        ClassObject* callerClass =
			// @zee getByte/Int() -> getBField/IField() -> current method
...
#ifdef FASTIVA
	jint fastiva_Dalvik_java_lang_reflect_Field_getFieldModifiers(java_lang_reflect_Field_p self, java_lang_Class_p clazz, jint);
	*(jint*)pResult = fastiva_Dalvik_java_lang_reflect_Field_getFieldModifiers((java_lang_reflect_Field_p)args[0], (java_lang_Class_p)declaringClass, slot);
}

jint fastiva_Dalvik_java_lang_reflect_Field_getFieldModifiers(java_lang_reflect_Field_p self, java_lang_Class_p declaringClass, jint slot) {
#endif
...
#ifdef FASTIVA
	java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Field_getField(java_lang_reflect_Field_p self, java_lang_Object_p, java_lang_Class_p, java_lang_Class_p, jint, jbool);
	*(java_lang_Object_p*)pResult = fastiva_Dalvik_java_lang_reflect_Field_getField((java_lang_reflect_Field_p)args[0], (java_lang_Object_p) obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck);
}

java_lang_Object_p fastiva_Dalvik_java_lang_reflect_Field_getField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck) {
#endif
...
#ifdef FASTIVA
	void fastiva_Dalvik_java_lang_reflect_Field_setField(java_lang_reflect_Field_p self, java_lang_Object_p, java_lang_Class_p, java_lang_Class_p, jint, jbool, java_lang_Object_p);
	fastiva_Dalvik_java_lang_reflect_Field_setField((java_lang_reflect_Field_p)args[0], obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, valueObj);
}

void fastiva_Dalvik_java_lang_reflect_Field_setField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, java_lang_Object_p valueObj) {
#endif
...
#ifdef FASTIVA
	jlonglong fastiva_Dalvik_java_lang_reflect_Field_getPrimitiveField(java_lang_reflect_Field_p self, java_lang_Object_p, java_lang_Class_p, java_lang_Class_p, jint, jbool, unicod);
	*(jlonglong*)pResult = fastiva_Dalvik_java_lang_reflect_Field_getPrimitiveField((java_lang_reflect_Field_p)args[0], obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, descriptor);
}

jlonglong fastiva_Dalvik_java_lang_reflect_Field_getPrimitiveField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor) {
	JValue res;
	JValue* pResult = &res;
#endif

    PrimitiveType targetType = dexGetPrimitiveTypeFromDescriptorChar((char)descriptor);
    const Field* field;
    JValue value;
...
#ifdef FASTIVA
jdouble fastiva_Dalvik_java_lang_reflect_Field_getDField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor) {
	JValue v;
	v.j = fastiva_Dalvik_java_lang_reflect_Field_getPrimitiveField((java_lang_reflect_Field_p)self, obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, descriptor);
	return v.d;
}
jfloat fastiva_Dalvik_java_lang_reflect_Field_getFField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor) {
	JValue v;
	v.i = (int)fastiva_Dalvik_java_lang_reflect_Field_getPrimitiveField((java_lang_reflect_Field_p)self, obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, descriptor);
	return v.f;
}
#endif
...
#ifdef FASTIVA
	void fastiva_Dalvik_java_lang_reflect_Field_setPField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor, const s4* valuePtr);
	fastiva_Dalvik_java_lang_reflect_Field_setPField((java_lang_reflect_Field_p)args[0], obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, descriptor, valuePtr);
}

void fastiva_Dalvik_java_lang_reflect_Field_setPrimitiveField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor, jint value) {
	void fastiva_Dalvik_java_lang_reflect_Field_setPField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor, const s4* valuePtr);
	fastiva_Dalvik_java_lang_reflect_Field_setPField((java_lang_reflect_Field_p)self, obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, descriptor, (const s4*)(void*)&value);
}

// It's for arm-eabi 64bit stack align case.
void fastiva_Dalvik_java_lang_reflect_Field_setPrimitiveField64(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor, jlonglong value) {
	void fastiva_Dalvik_java_lang_reflect_Field_setPField(java_lang_reflect_Field_p self, java_lang_Object_p obj, java_lang_Class_p declaringClass, java_lang_Class_p fieldType, jint slot, jbool noAccessCheck, unicod descriptor, const s4* valuePtr);
	fastiva_Dalvik_java_lang_reflect_Field_setPField((java_lang_reflect_Field_p)self, obj, (java_lang_Class_p)declaringClass, (java_lang_Class_p)fieldType, slot, noAccessCheck, descriptor, (const s4*)(void*)&value);
}
...
#ifdef FASTIVA
	java_lang_annotation_Annotation_ap fastiva_Dalvik_java_lang_reflect_Field_getDeclaredAnnotations(java_lang_Class_p clazz, jint);
	*(java_lang_annotation_Annotation_ap*)pResult = fastiva_Dalvik_java_lang_reflect_Field_getDeclaredAnnotations((java_lang_Class_p)declaringClass, slot);
}

java_lang_annotation_Annotation_ap fastiva_Dalvik_java_lang_reflect_Field_getDeclaredAnnotations(java_lang_Class_p declaringClass, jint slot) {
#endif
...
#ifdef FASTIVA
	java_lang_annotation_Annotation_p fastiva_Dalvik_java_lang_reflect_Field_getAnnotation(java_lang_Class_p clazz, jint, java_lang_Class_p);
	*(java_lang_annotation_Annotation_p*)pResult = fastiva_Dalvik_java_lang_reflect_Field_getAnnotation((java_lang_Class_p) clazz, slot, (java_lang_Class_p)annotationClazz);
}

java_lang_annotation_Annotation_p fastiva_Dalvik_java_lang_reflect_Field_getAnnotation(java_lang_Class_p clazz, jint slot, java_lang_Class_p annotationClazz) {
#endif

    Field* field = dvmSlotToField(clazz, slot);
    RETURN_PTR((java_lang_annotation_Annotation_p)dvmGetFieldAnnotation(clazz, field, annotationClazz));
}
...
#ifdef FASTIVA
	jbool fastiva_Dalvik_java_lang_reflect_Field_isAnnotationPresent(java_lang_Class_p clazz, jint, java_lang_Class_p);
	*(jbool*)pResult = fastiva_Dalvik_java_lang_reflect_Field_isAnnotationPresent((java_lang_Class_p)clazz, slot, (java_lang_Class_p)annotationClazz);
}

jbool fastiva_Dalvik_java_lang_reflect_Field_isAnnotationPresent(java_lang_Class_p clazz, jint slot, java_lang_Class_p annotationClazz) {
#endif
...
#ifdef FASTIVA
	java_lang_Object_ap fastiva_Dalvik_java_lang_reflect_Field_getSignatureAnnotation(java_lang_reflect_Field_p self, java_lang_Class_p clazz, jint);
	*(java_lang_Object_ap*)pResult = fastiva_Dalvik_java_lang_reflect_Field_getSignatureAnnotation((java_lang_reflect_Field_p)args[0], (java_lang_Class_p)declaringClass, slot);
}

java_lang_Object_ap fastiva_Dalvik_java_lang_reflect_Field_getSignatureAnnotation(java_lang_reflect_Field_p self, java_lang_Class_p declaringClass, jint slot) {
#endif
...
const DalvikNativeMethod dvm_java_lang_reflect_Field[] = {
    { "getFieldModifiers",  "(Ljava/lang/Class;I)I",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_getFieldModifiers) },
    { "getField",           "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZ)Ljava/lang/Object;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_getField) },
    { "getBField",          "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZC)B",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_getPrimitiveField) },
    ...
    { "getDField",          "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZC)D",
        Dalvik_java_lang_reflect_Field_getPrimitiveField, (void*)fastiva_Dalvik_java_lang_reflect_Field_getDField },
    { "getFField",          "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZC)F",
        Dalvik_java_lang_reflect_Field_getPrimitiveField, (void*)fastiva_Dalvik_java_lang_reflect_Field_getFField },
    ...
    { "setField",           "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZLjava/lang/Object;)V",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_setField) },
    { "setBField",          "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZCB)V",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_setPrimitiveField) },
    ...
    { "setDField",          "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/Class;IZCD)V",
        Dalvik_java_lang_reflect_Field_setPrimitiveField, (void*)fastiva_Dalvik_java_lang_reflect_Field_setPrimitiveField64 },
    ...
    { "getDeclaredAnnotations", "(Ljava/lang/Class;I)[Ljava/lang/annotation/Annotation;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_getDeclaredAnnotations) },
    { "getAnnotation", "(Ljava/lang/Class;ILjava/lang/Class;)Ljava/lang/annotation/Annotation;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_getAnnotation) },
    { "isAnnotationPresent", "(Ljava/lang/Class;ILjava/lang/Class;)Z",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_isAnnotationPresent) },
    { "getSignatureAnnotation",  "(Ljava/lang/Class;I)[Ljava/lang/Object;",
        FASTIVA_INTERNAL_METHOD_PAIR(Dalvik_java_lang_reflect_Field_getSignatureAnnotation) },
    { NULL, NULL, NULL, NULL },
};
