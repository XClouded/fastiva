...
{
#ifdef FATSIVA
	java_lang_String_p pStr = (java_lang_String_p)this;
	unicod* data = pStr->get__value()->getBuffer_unsafe$() + pStr->get__offset();
	int len = pStr->length_();
...
{
#ifdef FATSIVA
	return ((java_lang_String_p)this)->length();
#else
...
{
#ifdef FATSIVA
	return (ArrayObject*)((java_lang_String_p)this)->get__value();
#else
...
#ifdef FATSIVA
	java_lang_String_p pStr = (java_lang_String_p)this;
	return pStr->get__value()->getBuffer_unsafe$() + pStr->get__offset();
#else
    int offset = dvmGetFieldInt(this, STRING_FIELDOFF_OFFSET);
    ArrayObject* chars =
            (ArrayObject*) dvmGetFieldObject(this, STRING_FIELDOFF_VALUE);
