...
#else
        { &gDvm.classLibcoreReflectAnnotationFactory,     "Lorg/apache/harmony/lang/annotation/AnnotationFactory;" },
        { &gDvm.classLibcoreReflectAnnotationMember,      "Lorg/apache/harmony/lang/annotation/AnnotationMember;" },
        { &gDvm.classLibcoreReflectAnnotationMemberArray, "[Lorg/apache/harmony/lang/annotation/AnnotationMember;" },
#endif
        { NULL, NULL }
    };
...
#ifndef FASTIVA //_NO_VIRTUAL_METHOD_IN_FINAL_CLASS
        { &gDvm.voffJavaLangThreadGroup_removeThread, "Ljava/lang/ThreadGroup;",
          "removeThread", "(Ljava/lang/Thread;)V" },
#endif
        { NULL, NULL, NULL, NULL }
