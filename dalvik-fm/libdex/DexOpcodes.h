...
#ifdef _WIN32
#define DEFINE_GOTO_TABLE_w32()												 \
        H2(OP_NOP)                                                            \
        H2(OP_MOVE)                                                           \
        H2(OP_MOVE_FROM16)                                                    \
        H2(OP_MOVE_16)                                                        \
        H2(OP_MOVE_WIDE)                                                      \
        H2(OP_MOVE_WIDE_FROM16)                                               \
        H2(OP_MOVE_WIDE_16)                                                   \
        H2(OP_MOVE_OBJECT)                                                    \
        H2(OP_MOVE_OBJECT_FROM16)                                             \
        H2(OP_MOVE_OBJECT_16)                                                 \
        H2(OP_MOVE_RESULT)                                                    \
        H2(OP_MOVE_RESULT_WIDE)                                               \
        H2(OP_MOVE_RESULT_OBJECT)                                             \
        H2(OP_MOVE_EXCEPTION)                                                 \
        H2(OP_RETURN_VOID)                                                    \
        H2(OP_RETURN)                                                         \
        H2(OP_RETURN_WIDE)                                                    \
        H2(OP_RETURN_OBJECT)                                                  \
        ...
        H2(OP_CONST_WIDE_32)                                                  \
        H2(OP_CONST_WIDE)                                                     \
        H2(OP_CONST_WIDE_HIGH16)                                              \
        H2(OP_CONST_STRING)                                                   \
        H2(OP_CONST_STRING_JUMBO)                                             \
        H2(OP_CONST_CLASS)                                                    \
        H2(OP_MONITOR_ENTER)                                                  \
        H2(OP_MONITOR_EXIT)                                                   \
        H2(OP_CHECK_CAST)                                                     \
        ...
        H2(OP_NEW_INSTANCE)                                                   \
        H2(OP_NEW_ARRAY)                                                      \
        H2(OP_FILLED_NEW_ARRAY)                                               \
        H2(OP_FILLED_NEW_ARRAY_RANGE)                                         \
        H2(OP_FILL_ARRAY_DATA)                                                \
        H2(OP_THROW)                                                          \
        H2(OP_GOTO)                                                           \
        H2(OP_GOTO_16)                                                        \
        H2(OP_GOTO_32)                                                        \
        ...
        H2(OP_SPUT_CHAR)                                                      \
        H2(OP_SPUT_SHORT)                                                     \
        H2(OP_INVOKE_VIRTUAL)                                                 \
        H2(OP_INVOKE_SUPER)                                                   \
        H2(OP_INVOKE_DIRECT)                                                  \
        H2(OP_INVOKE_STATIC)                                                  \
        H2(OP_INVOKE_INTERFACE)                                               \
        H2(OP_UNUSED_73)                                                      \
        H2(OP_INVOKE_VIRTUAL_RANGE)                                           \
        H2(OP_INVOKE_SUPER_RANGE)                                             \
        H2(OP_INVOKE_DIRECT_RANGE)                                            \
        H2(OP_INVOKE_STATIC_RANGE)                                            \
        H2(OP_INVOKE_INTERFACE_RANGE)                                         \
        H2(OP_UNUSED_79)                                                      \
        H2(OP_UNUSED_7A)                                                      \
        H2(OP_NEG_INT)                                                        \
        H2(OP_NOT_INT)                                                        \
        ...
        H2(OP_LONG_TO_INT)                                                    \
        H2(OP_LONG_TO_FLOAT)                                                  \
        H2(OP_LONG_TO_DOUBLE)                                                 \
        H2(OP_FLOAT_TO_INT)                                                   \
        H2(OP_FLOAT_TO_LONG)                                                  \
        H2(OP_FLOAT_TO_DOUBLE)                                                \
        H2(OP_DOUBLE_TO_INT)                                                  \
        H2(OP_DOUBLE_TO_LONG)                                                 \
        H2(OP_DOUBLE_TO_FLOAT)                                                \
        H2(OP_INT_TO_BYTE)                                                    \
        H2(OP_INT_TO_CHAR)                                                    \
        H2(OP_INT_TO_SHORT)                                                   \
        H2(OP_ADD_INT)                                                        \
        ...
        H2(OP_SHL_INT_2ADDR)                                                  \
        H2(OP_SHR_INT_2ADDR)                                                  \
        H2(OP_USHR_INT_2ADDR)                                                 \
        H2(OP_ADD_LONG_2ADDR)                                                 \
        H2(OP_SUB_LONG_2ADDR)                                                 \
        H2(OP_MUL_LONG_2ADDR)                                                 \
        H2(OP_DIV_LONG_2ADDR)                                                 \
        H2(OP_REM_LONG_2ADDR)                                                 \
        H2(OP_AND_LONG_2ADDR)                                                 \
        H2(OP_OR_LONG_2ADDR)                                                  \
        H2(OP_XOR_LONG_2ADDR)                                                 \
        H2(OP_SHL_LONG_2ADDR)                                                 \
        H2(OP_SHR_LONG_2ADDR)                                                 \
        H2(OP_USHR_LONG_2ADDR)                                                \
        H2(OP_ADD_FLOAT_2ADDR)                                                \
        H2(OP_SUB_FLOAT_2ADDR)                                                \
        H2(OP_MUL_FLOAT_2ADDR)                                                \
        H2(OP_DIV_FLOAT_2ADDR)                                                \
        H2(OP_REM_FLOAT_2ADDR)                                                \
        H2(OP_ADD_DOUBLE_2ADDR)                                               \
        H2(OP_SUB_DOUBLE_2ADDR)                                               \
        H2(OP_MUL_DOUBLE_2ADDR)                                               \
        H2(OP_DIV_DOUBLE_2ADDR)                                               \
        H2(OP_REM_DOUBLE_2ADDR)                                               \
        H2(OP_ADD_INT_LIT16)                                                  \
        H2(OP_RSUB_INT)                                                       \
        H2(OP_MUL_INT_LIT16)                                                  \
        H2(OP_DIV_INT_LIT16)                                                  \
        ...
        H2(OP_SGET_VOLATILE)                                                  \
        H2(OP_SPUT_VOLATILE)                                                  \
        H2(OP_IGET_OBJECT_VOLATILE)                                           \
        H2(OP_IGET_WIDE_VOLATILE)                                             \
        H2(OP_IPUT_WIDE_VOLATILE)                                             \
        H2(OP_SGET_WIDE_VOLATILE)                                             \
        H2(OP_SPUT_WIDE_VOLATILE)                                             \
        H2(OP_BREAKPOINT)                                                     \
        H2(OP_THROW_VERIFICATION_ERROR)                                       \
        H2(OP_EXECUTE_INLINE)                                                 \
        H2(OP_EXECUTE_INLINE_RANGE)                                           \
        H2(OP_INVOKE_OBJECT_INIT_RANGE)                                       \
        H2(OP_RETURN_VOID_BARRIER)                                            \
        H2(OP_IGET_QUICK)                                                     \
        H2(OP_IGET_WIDE_QUICK)                                                \
        H2(OP_IGET_OBJECT_QUICK)                                              \
        H2(OP_IPUT_QUICK)                                                     \
        H2(OP_IPUT_WIDE_QUICK)                                                \
        H2(OP_IPUT_OBJECT_QUICK)                                              \
        H2(OP_INVOKE_VIRTUAL_QUICK)                                           \
        H2(OP_INVOKE_VIRTUAL_QUICK_RANGE)                                     \
        H2(OP_INVOKE_SUPER_QUICK)                                             \
        H2(OP_INVOKE_SUPER_QUICK_RANGE)                                       \
        H2(OP_IPUT_OBJECT_VOLATILE)                                           \
        H2(OP_SGET_OBJECT_VOLATILE)                                           \
        H2(OP_SPUT_OBJECT_VOLATILE)                                           \
        H2(OP_UNUSED_FF)                                                      \
